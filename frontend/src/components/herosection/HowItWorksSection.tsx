    ...
    <div className="bg-gray-50 py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-sm sm:text-base font-semibold leading-7 text-orange-600">Simple Process</h2>
        ...
        <div className="mx-auto mt-12 sm:mt-16 lg:mt-20 xl:mt-24 max-w-2xl sm:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-6 gap-y-12 sm:gap-x-8 sm:gap-y-16 lg:max-w-none lg:grid-cols-3">
            ...
            <div className="flex flex-col items-center text-center px-4">
              <div className="mb-4 sm:mb-6 flex h-12 w-12 sm:h-16 sm:w-16 items-center justify-center rounded-full bg-gradient-to-r from-orange-500 to-red-500 text-white">
        ...
        <div className="mt-12 sm:mt-16 text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 max-w-md sm:max-w-none mx-auto">
            <a
              href="#"
              className="w-full sm:w-auto rounded-lg bg-gradient-to-r from-orange-500 to-red-500 px-6 py-3 sm:px-8 text-sm sm:text-base font-semibold text-white shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
            >
              Start Booking Events
            </a>
            <a
              href="#"
              className="w-full sm:w-auto rounded-lg border-2 border-orange-500 bg-white px-6 py-3 sm:px-8 text-sm sm:text-base font-semibold text-orange-600 hover:bg-orange-50 transition-colors duration-200"
            >
